...
knn.py
------
A simple, from-scratch implementation of the K-Nearest Neighbors (KNN) classification algorithm.
...
class KNN:
    ...
    def accuracy(self, X, y):
        ...
        return np.mean(predictions == np.array(y, dtype=int))
    ...
    def confusion_matrix(self, X, y):
        ...
        -------
        pandas.DataFrame
            Confusion matrix indexed by true labels, columns as predicted labels.
        """
        predictions = self.predict(X)
